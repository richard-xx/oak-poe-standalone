...
def create_pipeline(port=5000, blob_path=None, config_path=None, host_ip=None):
    ...
    manipNn.setMaxOutputFrameSize(nn_config["inputSize"][0] * nn_config["inputSize"][1] * 3)
...
if __name__ == '__main__':
    ...
    blobPath = Path(__file__).parent / "models/yolov6_640_openvino_2021.4_6shave.blob"
    configPath = Path(__file__).parent / "models/yolov6_640.json"
